            ...
            >
              <div class="results-listing">
                <SfProductCard
                  ...
                  "
                  :score-rating="5 || productGetters.getAverageRating(product)"
                  :reviews-count="7"
                  :image="searchGetters.getItemImages(product)[0].url"
                  :alt="searchGetters.getItemName(product)"
...
export default {
  ...
  setup(props) {
    ...
    const products = computed(() => searchGetters.getItems(props.result))
    const categories = computed(() =>
      searchGetters.getCategoryTree(props.result),
    )
