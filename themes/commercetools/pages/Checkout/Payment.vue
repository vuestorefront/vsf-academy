  ...
  <div>
    ...
    <div class="summary">
      <div class="summary__group">
        ...
        />
        <%_ if (options.payment.tag === 'adyen') { _%>
        ...
        <%_ } _%>
        <%_ if (!options.payment.makesOrder) { _%>
...
<%_ if (!options.payment.makesOrder) { _%>
import { useMakeOrder, useCart, useBilling, useShipping, useShippingProvider, cartGetters } from '<%= options.generate.replace.composables %>';
<%_ } else { _%>
import { useCart, useBilling, useShipping, useShippingProvider, cartGetters } from '<%= options.generate.replace.composables %>';
<%_ } _%>
import { onSSR } from '@vue-storefront/core';
<%_ if (options.payment.tag === 'adyen') { _%>
import PaymentAdyenProvider from '@vsf-enterprise/adyen/src/PaymentAdyenProvider';
<%_ } else { _%>
