...
const taxCategoryExtension = require('./extensions/taxCategoryExtension')

module.exports = {
  integrations: {
    ct: {
      location: '@vue-storefront/commercetools-api/server',
      extensions: existing => [...existing, '@vsf-enterprise/commercetools/extensions', taxCategoryExtension],
      configuration: {
